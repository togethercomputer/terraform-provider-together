...
var _ resource.ResourceWithConfigure = (*AudioTranscriptionResource)(nil)
var _ resource.ResourceWithModifyPlan = (*AudioTranscriptionResource)(nil)

func NewResource() resource.Resource {
	return &AudioTranscriptionResource{}
}

// AudioTranscriptionResource defines the resource implementation.
...
func (r *AudioTranscriptionResource) Create(ctx context.Context, req resource.CreateRequest, resp *resource.CreateResponse) {
	var data *AudioTranscriptionModel
	...
	_, err = r.client.Audio.Transcriptions.New(
		ctx,
		together.AudioTranscriptionNewParams{},
...
func (r *AudioTranscriptionResource) ModifyPlan(ctx context.Context, req resource.ModifyPlanRequest, resp *resource.ModifyPlanResponse) {
