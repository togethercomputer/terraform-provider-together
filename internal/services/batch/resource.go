...
var _ resource.ResourceWithConfigure = (*BatchResource)(nil)
var _ resource.ResourceWithModifyPlan = (*BatchResource)(nil)

func NewResource() resource.Resource {
	return &BatchResource{}
}

// BatchResource defines the resource implementation.
...
func (r *BatchResource) Create(ctx context.Context, req resource.CreateRequest, resp *resource.CreateResponse) {
	...
	_, err = r.client.Batches.New(
		ctx,
		together.BatchNewParams{},
