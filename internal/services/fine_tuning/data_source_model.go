...
type FineTuningDataSourceModel struct {
	...
	Events               customfield.NestedObjectList[FineTuningEventsDataSourceModel]     `tfsdk:"events" json:"events,computed"`
	LrScheduler          customfield.NestedObject[FineTuningLrSchedulerDataSourceModel]    `tfsdk:"lr_scheduler" json:"lr_scheduler,computed"`
	TrainingMethod       customfield.NestedObject[FineTuningTrainingMethodDataSourceModel] `tfsdk:"training_method" json:"training_method,computed"`
	TrainingType         customfield.NestedObject[FineTuningTrainingTypeDataSourceModel]   `tfsdk:"training_type" json:"training_type,computed"`
...
type FineTuningEventsDataSourceModel struct {
...
type FineTuningLrSchedulerDataSourceModel struct {
	LrSchedulerType types.String                                                                  `tfsdk:"lr_scheduler_type" json:"lr_scheduler_type,computed"`
	LrSchedulerArgs customfield.NestedObject[FineTuningLrSchedulerLrSchedulerArgsDataSourceModel] `tfsdk:"lr_scheduler_args" json:"lr_scheduler_args,computed"`
}

type FineTuningLrSchedulerLrSchedulerArgsDataSourceModel struct {
...
type FineTuningTrainingMethodDataSourceModel struct {
...
type FineTuningTrainingTypeDataSourceModel struct {
	Type                 types.String  `tfsdk:"type" json:"type,computed"`
