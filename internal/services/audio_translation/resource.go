...
var _ resource.ResourceWithConfigure = (*AudioTranslationResource)(nil)
var _ resource.ResourceWithModifyPlan = (*AudioTranslationResource)(nil)

func NewResource() resource.Resource {
	return &AudioTranslationResource{}
}

// AudioTranslationResource defines the resource implementation.
...
func (r *AudioTranslationResource) Create(ctx context.Context, req resource.CreateRequest, resp *resource.CreateResponse) {
	var data *AudioTranslationModel
	...
	_, err = r.client.Audio.Translations.New(
		ctx,
		together.AudioTranslationNewParams{},
...
func (r *AudioTranslationResource) ModifyPlan(ctx context.Context, req resource.ModifyPlanRequest, resp *resource.ModifyPlanResponse) {
