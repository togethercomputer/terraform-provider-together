...
var _ resource.ResourceWithConfigure = (*CompletionResource)(nil)
var _ resource.ResourceWithModifyPlan = (*CompletionResource)(nil)
...
func (r *CompletionResource) Create(ctx context.Context, req resource.CreateRequest, resp *resource.CreateResponse) {
	...
	_, err = r.client.Completions.New(
		ctx,
		together.CompletionNewParams{},
...
func (r *CompletionResource) ModifyPlan(ctx context.Context, req resource.ModifyPlanRequest, resp *resource.ModifyPlanResponse) {
