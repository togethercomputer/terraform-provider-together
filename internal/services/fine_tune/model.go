...
type FineTuneModel struct {
	...
	LrScheduler          customfield.NestedObject[FineTuneLrSchedulerModel]    `tfsdk:"lr_scheduler" json:"lr_scheduler,computed_optional"`
	TrainingMethod       customfield.NestedObject[FineTuneTrainingMethodModel] `tfsdk:"training_method" json:"training_method,computed_optional"`
	TrainingType         customfield.NestedObject[FineTuneTrainingTypeModel]   `tfsdk:"training_type" json:"training_type,computed_optional"`
	...
	Events               customfield.NestedObjectList[FineTuneEventsModel]     `tfsdk:"events" json:"events,computed"`
}

func (m FineTuneModel) MarshalJSON() (data []byte, err error) {
	return apijson.MarshalRoot(m)
}

func (m FineTuneModel) MarshalJSONForUpdate(state FineTuneModel) (data []byte, err error) {
	return apijson.MarshalForUpdate(m, state)
}

type FineTuneLrSchedulerModel struct {
	LrSchedulerType types.String                                                      `tfsdk:"lr_scheduler_type" json:"lr_scheduler_type,required"`
	LrSchedulerArgs customfield.NestedObject[FineTuneLrSchedulerLrSchedulerArgsModel] `tfsdk:"lr_scheduler_args" json:"lr_scheduler_args,computed_optional"`
}

type FineTuneLrSchedulerLrSchedulerArgsModel struct {
...
type FineTuneTrainingMethodModel struct {
...
type FineTuneTrainingTypeModel struct {
...
type FineTuneEventsModel struct {
