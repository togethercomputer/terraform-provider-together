...
var _ resource.ResourceWithConfigure = (*EmbeddingResource)(nil)
var _ resource.ResourceWithModifyPlan = (*EmbeddingResource)(nil)
...
func (r *EmbeddingResource) Create(ctx context.Context, req resource.CreateRequest, resp *resource.CreateResponse) {
	...
	_, err = r.client.Embeddings.New(
		ctx,
		together.EmbeddingNewParams{},
...
func (r *EmbeddingResource) ModifyPlan(ctx context.Context, req resource.ModifyPlanRequest, resp *resource.ModifyPlanResponse) {
